...
### Pattern 1: DIE(string) - Plain String Errors
Tests: 6/6 ✅

- ✅ throws plain string with simple message
- ✅ throws plain string with whitespace trimmed
...
- ✅ throws with simple template string
- ✅ works with nullish coalescing
- ✅ works with logical OR
...
- ✅ throws with single interpolated value
- ✅ throws with multiple interpolated values
- ✅ throws with string interpolation
- ✅ throws with Error object interpolation
- ✅ throws with number and boolean interpolation
- ✅ throws with object interpolation
...
|---------|-------------|-------|--------|
| Pattern 1 | Plain string errors | 6 | ✅ |
| Pattern 2 | Error objects | 4 | ✅ |
| Pattern 3 | Tagged templates (no interpolation) | 3 | ✅ |
| Pattern 4 | Tagged templates (with interpolation) | 6 | ✅ |
